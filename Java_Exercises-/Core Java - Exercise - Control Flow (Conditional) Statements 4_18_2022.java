...
public class javaExcersiseLoops {
...
//		if (x < 10) {
//			System.out.println(x + " Less than 10");
//		}else if (x <20 ) {System.out.print(x + " Between 10 and 20");
...
//		
//		int x = 5;
//		if ((x < 10) || (x > 20)) {System.out.println(x + " Out of range");
//		}else {System.out.println(x + " In range");}
//
...
//		}else if (grade <= 69) {System.out.println("D");
//		}else if (grade <= 79) {System.out.println("C");
//		}else if (grade <= 89) {System.out.println("B");
